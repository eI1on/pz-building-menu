...
function ISDoubleClothingRack:walkTo(x, y, z)
...
function ISDoubleClothingRack:setInfo(square, north, sprite)
	...
	-- local _clothingrackInv = ItemContainer.new()
    -- _clothingrackInv:setType('shelves')
	-- _clothingrackInv:removeAllItems()
    -- _clothingrackInv:setCapacity(50)
    -- _clothingrackInv:setParent(self.javaObject)
    -- thumpable:setContainer(_clothingrackInv)
...
function ISDoubleClothingRack:removeFromGround(square)
...
function ISDoubleClothingRack:isValid(square)
...
function ISDoubleClothingRack:getSquare2Pos(square, north)
	local x = square:getX()
	local y = square:getY()
	local z = square:getZ()
	if north then
...
function ISDoubleClothingRack:getSquare2(square, north)
