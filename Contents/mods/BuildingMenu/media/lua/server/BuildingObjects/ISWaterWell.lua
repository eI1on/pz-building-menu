        ...
        for iB, vB in ipairs(ISWaterWell.WaterWells) do
            if vB.waterAmount < vB.waterMax then
                ...
                if vB.exterior then
                    ...
                    if obj then
                        noise('added rain to WaterWell at ' .. vB.x .. ',' .. vB.y .. ',' .. vB.z .. ' waterAmount=' ..
                                  vB.waterAmount .. ' rainIntensity=' .. rainIntensity)
    ...
    for iB, vB in ipairs(ISWaterWell.WaterWells) do
        if vB.waterAmount < vB.waterMax then
            ...
            if square then
                ...
                local obj = ISWaterWell.findObject(square)
                if obj then
                    noise('added water to WaterWell at ' .. vB.x .. ',' .. vB.y .. ',' .. vB.z .. ' waterAmount=' ..
                              vB.waterAmount)
                    obj:setWaterAmount(vB.waterAmount)
                    obj:transmitModData()
                end
...
function ISWaterWell.loadRainWaterWell(WaterWellObject)
    ...
    if not WaterWell then
        ...
        table.insert(ISWaterWell.WaterWells, WaterWell)
        noise('new WaterWell created ' .. WaterWell.x .. ',' .. WaterWell.y .. ' with ' .. WaterWell.waterAmount ..
                  ' water')
    else
