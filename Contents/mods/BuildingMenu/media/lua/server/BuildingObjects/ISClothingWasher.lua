--- @class ISClothingWasher : ISBuildingObject
ISClothingWasher = ISBuildingObject:derive('ISClothingWasher');

--- Creates a new clothing washer object at a given position
--- @param x integer The x coordinate of the washer
--- @param y integer The y coordinate of the washer
--- @param z integer The z coordinate of the washer
--- @param north boolean The orientation of the washer
--- @param sprite string The sprite used to visually represent the washer
...
--- Checks if the placement of the washer is valid on the given square
--- @param square IsoGridSquare The square where the washer is to be placed
--- @return boolean validity True if the washer can be placed, false otherwise
...
--- Renders a ghost tile of the clothing washer, delegates to the superclass
...
--- Initializes a new instance of ISClothingWasher
--- @param playerNum integer The player index building the clothing washer
--- @param name string The name of the clothing washer
...
--- @return ISClothingWasher ISBuildingObject instance
function ISClothingWasher:new(playerNum, name, sprite, northSprite)
  local o = {};
  setmetatable(o, self);
  self.__index = self;
  o:init();
