--[[
  crc32.lua - Pure Lua CRC-32 Implementation

  Author: SafeteeWoW (https://gist.github.com/SafeteeWoW)
  Repository: SafeteeWoW/crc32.lua
  Last Active: 3 years ago
  License: zlib License

  Description:
  This script provides a pure Lua implementation of the CRC-32 checksum algorithm.
  It has no external dependencies and is optimized for performance.

  Usage:
  local crc32 = LibDeflate:Crc32("your_string_here")
  print("CRC-32 checksum:", crc32)
  ...
  For more information, please refer to the zlib License.

  Notes:
  - This implementation caches intermediate results to improve performance.
  - It provides the ability to use an initial CRC value, which is useful in certain applications.
]] --
...
--- @param init_value nil|integer The initial crc32 value. If nil, uses 0.
--- @return integer checksum The CRC-32 checksum, which is greater or equal to 0, and less than 2^32 (4294967296).
